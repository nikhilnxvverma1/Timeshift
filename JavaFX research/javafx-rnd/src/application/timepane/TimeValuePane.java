...
import application.selection.SelectionOverlap;

public class TimeValuePane extends AnchorPane implements SelectionOverlap{
	...
	public TimeValuePane(double totalTime,double length){
		this.length=length;
...
//					//only for testing
////					if(selectedKey==null){
////						double clickedAreaTime=timeAtX(event.getX());
////						addKeyAt(clickedAreaTime, null);
////					}
//					
//				}
////				dragMade=false;
...
//			key.setSelected(false);
	...
	public void addKeyAt(double time,KeyValue keyValue){
		...
		Iterator<Node> iterator=keyContainer.getChildren().iterator();
		while(iterator.hasNext()){
			
			TimeValueKey key=(TimeValueKey)iterator.next();			
